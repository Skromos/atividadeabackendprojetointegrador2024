...
<body style="display: grid; grid-template-columns: repeat(2, minmax(0, 1fr));">
  ...
  <div class="container">
    ...
    <form action="#" method="post">
      ...
      <div class="form-group">
        <label for="imagem">Upload de laudo médico:</label>
